	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item <?=$showCholestrol?>"><a href="?page=High Cholestrol" class="nav-link">High Cholestrol</a></li>
	        	<li class="nav-item <?=$showBoth?>"><a href="?page=both" class="nav-link">Both Diabetic & High cholestrol</a></li>
